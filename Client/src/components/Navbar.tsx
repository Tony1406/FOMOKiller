    ...
    return (
        <nav className="app-nav">
            ...
            <div className="nav-logo">
                <NavLink to="/" end className={({ isActive }) => `nav-item nav-logo-btn${isActive ? ' active' : ''}`}>
            ...
            <div className="nav-main-items">
                ...
                <NavLink to="/backlog" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
                    <span className="nav-icon">
                        <img src={backlogIcon} alt="Backlog" className="nav-icon-img" />
                    </span>
                    <span className="nav-label">Backlog</span>
                </NavLink>
                <NavLink to="/top5" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
                    <span className="nav-icon">
